                ...
                <Navbar dark expand="md">
                    <div className="container">
                        ...
                        <Collapse isOpen={this.state.isNavOpen} navbar >
                            ...
                            <Nav navbar>
                                <NavItem>
                                    <NavLink className="nav-link awsm-link" to="/home">
                                        <span className="fa fa-home fa-lg"></span> Home
                                </NavLink>
                                </NavItem>

                                <NavItem>
                                    <NavLink className="nav-link awsm-link" to="/aboutus">
                                        <span className="fa fa-info fa-lg"></span> About us
                                </NavLink>
                                </NavItem>

                                <NavItem>
                                    <NavLink className="nav-link awsm-link" to="/menu">
                                        <span className="fa fa-list fa-lg"></span> Menu
                                </NavLink>
                                </NavItem>

                                <NavItem>
                                    <NavLink className="nav-link awsm-link" to="/projectmenu">
                                        <span className="fa fa-list fa-lg"></span> Project
                                </NavLink>
                                </NavItem>

                                <NavItem>
                                    <NavLink className="nav-link awsm-link" to="/soundmenu">
                                        <span className="fa fa-list fa-lg"></span> Sound
                                </NavLink>
                                </NavItem>

                                <NavItem>
                                    <NavLink className="nav-link awsm-link" to="/contactus">
                            ...
                            <Nav className="ml-auto" navbar>
                                <NavItem>
                                    <Button>
                                        <NavLink className="nav-link awsm-link" to="/login">
